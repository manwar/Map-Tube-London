...
$Map::Tube::London::Line::Northern::VERSION   = '0.49';
...
=head2 Bank Branch
    ...
    | London Bridge            | Bank, Elephant and Castle             |
    | Elephant and Castle      | London Bridge                         |
    +--------------------------+---------------------------------------+
...
=item * The station "Leicester Square" is also part of Picadilly Line.
...
London Metro: L<Northern|https://raw.githubusercontent.com/Manwar/Map-Tube-London/master/maps/Northern.png>
line map generated by plugin L<Map::Tube::Plugin::Graph>.
