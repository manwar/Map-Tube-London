...
$Map::Tube::London::Line::Central::VERSION   = '0.70';
...
=item * The station "Blackhorse Road" is also part of L<Victoria Line|Map::Tube::London::Line::Victoria>.

=item * The station "Willesden Junction" is also part of L<Bakerloo Line|Map::Tube::London::Line::Bakerloo>.

=item * The station "Queen's Park" is also part of L<Bakerloo Line|Map::Tube::London::Line::Bakerloo>.
...
=item * The station "West Brompton" is also part of L<District Line|Map::Tube::London::Line::District>.

=item * The station "Gunnersbury" is also part of L<District Line|Map::Tube::London::Line::District>.

=item * The station "Clapham High Street" is also part of L<Northern Line|Map::Tube::London::Line::Northern>.

=item * The station "Canada Water" is also part of L<Jubilee Line|Map::Tube::London::Line::Jubilee>.

=item * The station "Shadwell" is also part of L<Dockland Light Railway Line|Map::Tube::London::Line::DLR>.

=item * The station "Whitechapel" is also part of L<District Line|Map::Tube::London::Line::District>
        | L<Hammersmith & City Line|Map::Tube::London::Line::HammersmithCity>.

=item * The station "Highbury & Islington" is also part of L<Victoria Line|Map::Tube::London::Line::Victoria>.

=item * The station "Stratford" is also part of L<Jubilee Line|Map::Tube::London::Line::Jubilee>
        | L<Central Line|Map::Tube::London::Line::Central>
        | L<Dockland Light Railway Line|Map::Tube::London::Line::DLR>.

=item * The station "West Hampstead" is also part of L<Jubilee Line|Map::Tube::London::Line::Jubilee>.
