...
$Map::Tube::London::Line::DLR::VERSION   = '0.74';
...
=item * The station "Canning Town" is also part of L<Jubilee Line|Map::Tube::London::Line::Jubilee>.

=item * The station "Canary Wharf" is also part of L<Jubilee Line|Map::Tube::London::Line::Jubilee>.

=item * The station "Monument" is also part of L<District Line|Map::Tube::London::Line::District>.
...
=item * The station "Shadwell" is also part of L<London Overground Line|Map::Tube::London::Line::Overground>.
